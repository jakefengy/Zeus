...
public class TestDaoGenerator {
    ...
    public void generate() throws Exception {
        ...
        daoGenerator.generateAll(schema, "./daoGenerator/src-gen", null, "../daoGenerator/src");
        daoGenerator.generateAll(schema2, "./daoGenerator/src-gen", null, "../daoGenerator/src");
    }
